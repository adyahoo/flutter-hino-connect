...
class RegexPattern {
  /// Username regex
  /// Requires minimum 3 character, lowercase
  /// Allowing "_" and "." in middle of name
  static Pattern username = r'^[a-z][a-z0-9_.]+[a-z0-9]$';

  static Pattern personName = r'^[A-Za-z][A-Za-z\-]+([\ A-Za-z][A-Za-z\-]+)*$';
  ...
  /// DateTime regex (UTC)
  /// Unformatted date time (UTC and Iso6601)
  /// Example: 2020-04-27 06:14:39.977, 2020-04-27T06:14:39.977, 2020-04-27 01:14:39.977Z
  ...
  /// Minimum character: 6
  static Pattern passwordEasy = r'^\S{6,}$';

  /// Password (Easy) Regex
  /// Allowing all character
  /// Minimum character: 6
  static Pattern passwordEasyAllowedWhitespace = r'^[\S ]{6,}$';

  /// Password (Normal) Regex
  /// Allowing all character except 'whitespace'
  /// Must contains at least: 1 letter & 1 number
  /// Minimum character: 6
  static Pattern passwordNormal1 = r'^(?=.*[A-Za-z])(?=.*\d)\S{6,}$';
  ...
  /// Must contains at least: 1 letter & 1 number
  /// Minimum character: 6
  static Pattern passwordNormal2 = r'^(?=.*[A-Za-z])(?=.*\d)[a-zA-Z0-9]{6,}$';
  ...
  /// Minimum character: 6
  static Pattern passwordNormal3 = r'^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)\S{6,}$';
...
class RegexValidation {
  ...
  static bool hasMatch(String? s, Pattern p) =>
      (s == null) ? false : RegExp(p as String).hasMatch(s);
}